<div class="mt-5">
    <div class="border border-dotted border-gray-400 rounded-lg p-4">
        <button id="toggleButtons" class="flex items-center w-full text-left focus:outline-none">
            <div class="flex items-center justify-center">
                <span class="text-gray-600 mr-2 text-xl">
                    📄
                </span>
                <span class="text-gray-800 font-medium">Add a short introduction</span>
            </div>
        </button>

        <div id="content_introduction" class="mt-4 max-h-0 overflow-hidden transition-all duration-500 ease-in-out">
            <div class="p-4 border border-solid border-gray-200 rounded-lg">
                <div class="flex items-center justify-between mb-4">
                    <h2 class="text-lg font-bold">Short Introduction</h2>
                    <button x-data @click="$dispatch('show-introduction-modal')" class="text-blue-600 hover:text-blue-800">
                ...
                @if (is_null($shortIntroductions->introduction))
                    <p class="text-gray-500 mt-2">Please fill your information</p>
                @else
                    <div class="grid grid-cols-7 mt-2">
                        <p class="text-black font-bold col-span-2">Short Introduction: </p>
                        <p class="text-gray-700 col-span-5">{{ $shortIntroductions->introduction }}</p>
                    </div>
                @endif
            </div>
        </div>
    ...
    <div x-data="{ show: false }"
        x-show="show"
        x-on:show-introduction-modal.window="show = true"
        x-on:hide-introduction-modal.window="show = false"
        ...
        <div @click.away="show = false"
            ...
            <form wire:submit.prevent="save">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h3 class="text-xl font-semibold text-gray-800">Edit Short Introduction</h3>
                </div>
                <div class="p-6 space-y-6">
                    <h2 class="text-xl font-bold text-gray-800">Add an introduction</h2>
                    <p class="text-gray-800 mt-4 mb-2">Introduction</p>
                    <textarea class="mt-1 block w-full rounded-md border p-2 shadow-sm placeholder-gray-400 focus:border-blue-500 focus:ring-blue-500"
                                rows="4"
                                wire:model.defer="introduction"
                                placeholder="Write a short intro to tell people about yourself."></textarea>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const content_introduction = document.getElementById('content_introduction');
